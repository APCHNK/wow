            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        ['key' => 'field_' . $p . '_card_title_top', 'label' => 'Title Top', 'name' => 'title_top', 'type' => 'text', 'instructions' => 'E.g. "A WEDDING IN". Leave empty to use the project title.'],
                        ['key' => 'field_' . $p . '_card_country', 'label' => 'Country', 'name' => 'country', 'type' => 'text', 'instructions' => 'E.g. "ROME". Adds the decorative circle.'],
                        [
