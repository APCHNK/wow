    ...
    return [
        ...
        [
            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'instructions' => 'Each card links to a project category and shows your image + the category name.',
                    'sub_fields' => [
                        [
                            'key' => 'field_' . $p . '_scard_category',
                            'label' => 'Category',
                            'name' => 'category',
                            'type' => 'taxonomy',
                        ...
                        ['key' => 'field_' . $p . '_scard_title', 'label' => 'Title (optional)', 'name' => 'title', 'type' => 'text', 'instructions' => 'Leave empty to use the category name.'],
                    ],
                ],
            ],
        ],
        ...
        [
            ...
            'sub_fields' => [
                ...
                [
                    'key' => 'field_' . $p . '_catalog_grid_children_cards',
                    'label' => 'Children Category Cards (optional, parent categories)',
                    'name' => 'children_cards',
                    'type' => 'repeater',
                    'layout' => 'block',
                    'button_label' => 'Add Category Card',
                    'instructions' => 'On a parent category page. Leave empty for auto (all children with their term image/name).',
                    'sub_fields' => [
                        [
                            'key' => 'field_' . $p . '_ccard_category',
                            'label' => 'Category',
                            'name' => 'category',
                            'type' => 'taxonomy',
                            'taxonomy' => 'project_category',
                        ...
                        ['key' => 'field_' . $p . '_ccard_image', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'url', 'preview_size' => 'medium'],
                        ['key' => 'field_' . $p . '_ccard_title_top', 'label' => 'Title Top', 'name' => 'title_top', 'type' => 'text', 'instructions' => 'Leave empty to use the category name.'],
                        ['key' => 'field_' . $p . '_ccard_country', 'label' => 'Country', 'name' => 'country', 'type' => 'text'],
                        [
                            'key' => 'field_' . $p . '_ccard_desc_slider',
                            ...
                            'button_label' => 'Add Slide',
                            'sub_fields' => [
                                ['key' => 'field_' . $p . '_ccard_desc_text', 'label' => 'Text', 'name' => 'text', 'type' => 'textarea', 'rows' => 2],
                            ],
                        ],
                    ],
                ],
                [
                    'key' => 'field_' . $p . '_catalog_grid_project_cards',
                    'label' => 'Project Cards (optional, leaf categories)',
                    'name' => 'project_cards',
                    'type' => 'repeater',
                    'layout' => 'block',
                    'button_label' => 'Add Project Card',
                    'instructions' => 'On a leaf category page. Leave empty for auto (all projects in this category).',
                    'sub_fields' => [
                        [
                            'key' => 'field_' . $p . '_card_project',
                            'label' => 'Project',
                            'name' => 'project',
                            'type' => 'post_object',
                        ...
                        ['key' => 'field_' . $p . '_card_title_top', 'label' => 'Title Top', 'name' => 'title_top', 'type' => 'text', 'instructions' => 'Leave empty to use the project title.'],
