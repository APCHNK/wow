        ...
        [
            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'layout' => 'block',
                    'button_label' => 'Add Card',
                    'instructions' => 'Leave empty to auto-list children (on a parent category) or projects (on a leaf category). Fill to manually pick and customize each card.',
                    'sub_fields' => [
                        [
                            'key' => 'field_' . $p . '_card_target',
                            'label' => 'Link to',
                            'name' => 'target',
                            'type' => 'radio',
                            'choices' => [
                        ...
                        [
                            ...
                            'add_term' => 0,
                            'conditional_logic' => [[
                                ['field' => 'field_' . $p . '_card_target', 'operator' => '==', 'value' => 'category'],
                            ]],
                        ],
                        [
                            ...
                            'multiple' => 0,
                            'conditional_logic' => [[
                                ['field' => 'field_' . $p . '_card_target', 'operator' => '==', 'value' => 'project'],
                            ]],
                        ],
                        ['key' => 'field_' . $p . '_card_image', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'url', 'preview_size' => 'medium', 'instructions' => 'Optional for projects — leave empty to use the project featured image.'],
                        ['key' => 'field_' . $p . '_card_title_top', 'label' => 'Title Top', 'name' => 'title_top', 'type' => 'text', 'instructions' => 'Leave empty to use the category/project name.'],
