    ...
    <div class="about-slider">
        ...
        <div class="swiper about-swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/<?php echo $img; ?>" alt="<?php echo esc_attr(pll__('About')); ?>" loading="lazy" decoding="async">
                </div>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
        ...
        <div class="slider-nav">
            <button class="slider-btn slider-prev" aria-label="<?php echo esc_attr(pll__('Previous')); ?>">
            ...
            <button class="slider-btn slider-next" aria-label="<?php echo esc_attr(pll__('Next')); ?>">
                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
