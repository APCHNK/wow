...
$btn_text = wow_field('archive_hero_btn_text', '');
$btn_link = wow_field('archive_hero_btn_link', '');
...
<section class="wedding-projects-hero">
    ...
    <div class="wedding-projects-hero-bottom">
        ...
        <?php if ($btn_text) : ?>
            <a href="<?php echo esc_url($btn_link ?: '#'); ?>" class="footer-btn wedding-projects-hero-btn">
