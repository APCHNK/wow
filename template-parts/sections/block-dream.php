...
<section class="dream" id="dream">
    ...
    <div class="dream-slider">
        ...
        <div class="dream-nav">
            <button class="dream-btn dream-prev" aria-label="<?php echo esc_attr(pll__('Previous')); ?>">
            ...
            <button class="dream-btn dream-next" aria-label="<?php echo esc_attr(pll__('Next')); ?>">
                <svg width="15" height="14" viewBox="0 0 15 14" fill="none">
