...
<section class="wedding-project-gallery">
    ...
    <div class="wedding-project-gallery-slider">
        ...
        <div class="wedding-project-gallery-nav">
            <button class="wedding-project-gallery-prev" aria-label="<?php echo esc_attr(pll__('Previous')); ?>">
            ...
            <button class="wedding-project-gallery-next" aria-label="<?php echo esc_attr(pll__('Next')); ?>">
                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
