...
function wow_register_acf_fields() {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_project_tab_gallery',
                'label' => 'Settings for page',
                'name' => '',
                'type' => 'tab',
            ],
            [
                'key' => 'field_project_hero_title',
                'label' => 'Hero Title',
                'name' => 'project_hero_title',
                'type' => 'text',
            ],
            [
                'key' => 'field_project_hero_desc',
                'label' => 'Hero Description',
                'name' => 'project_hero_desc',
                'type' => 'textarea',
                'rows' => 3,
            ],
            [
                'key' => 'field_project_read_more_text',
                'label' => 'Read More Text',
                'name' => 'project_read_more_text',
                'type' => 'textarea',
                'rows' => 5,
            ],
            [
            ...
            [
                'key' => 'field_project_gallery_desc',
                'label' => 'Gallery Description',
                'name' => 'project_gallery_desc',
                'type' => 'textarea',
                'instructions' => 'Description text in the gallery section',
            ],
            [
                'key' => 'field_project_gallery_btn_text',
                'label' => 'Gallery Button Text',
                'name' => 'project_gallery_btn_text',
                'type' => 'text',
                'default_value' => 'CONTACT US',
            ],
            [
                'key' => 'field_project_gallery_btn_link',
                'label' => 'Gallery Button Link',
                'name' => 'project_gallery_btn_link',
                'type' => 'url',
            ],
            [
                ...
                'return_format' => 'array',
                'preview_size' => 'medium',
                'instructions' => 'Photos for the gallery slider',
            ],
        ],
        'location' => [
            [
